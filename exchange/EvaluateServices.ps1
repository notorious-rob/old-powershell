...
function funHelp()
{
 $descriptionText= `
@"
 NAME: EvaluateServices.ps1
 DESCRIPTION:
 Counts services on a local or remote machine. It then
 produces a report that tells how many services are auto,
 ...
 -list produces the service report
 -outfile writes report to a temporary file
 -display when used with -outfile displays report in
  wordpad. When used alone is ignored
...
@"
 ...
 to a temp file, and displays same in Wordpad
 ...
 EvaluateServices.ps1 -help

 Prints the help topic for the script

 EvaluateServices.ps1 -help -full

 Prints full help topic for the script

 EvaluateServices.ps1 -help -examples

 Prints only the examples for the script

 EvaluateServices.ps1 -examples
...
$string = Funline("There are $($objWMIService.length) services defined on $computer")
$string +=  @"
...
if($full)     { funhelp }
if($list)     { funlist }
if(!$list)    { "missing parameter" ; funhelp }

# SIG # Begin signature block
# MIIkCgYJKoZIhvcNAQcCoIIj+zCCI/cCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUyIZ/YpWemkmU7NLJMfYMxrk8
# wqWggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUKuNMML44+HyoSNoJ
# jWxl8rlUxAYwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAJ308KBSOJXFZCyjoj0Ej+T7kQagR
# LJvgxVkMkqI+JXZxxlb8g4l0gqaZPz6RsF9IWbtJWzH0juqAjnVqEpdNCuZyHP30
# V99yg4TTrQ514Tm2b8TDHXd+6/EeC+k7jqz4JuwSG2TyIJaCGfPPVKiigxrnh5Dn
# /1TTyDH8wwDukafjC9NmUT/jf2t50kccDpsneP9WHJQ+ZKYcjuo/pV4avGKEtpDn
# peQbODRcOcUJvKVeD3YFzXJMvezZi24ULRYUWx+4RFWuJH/isVNtUa8lPvk+jbFU
# XmYSCRT4Y24zmNwwpZbvWKPcAoyVrJC9NbhJLPYwKQFRdAB0lDeEMU17XaGCAh8w
...
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTA4MDIwMjA1NTgyOVowIwYJKoZIhvcN
# AQkEMRYEFMG3RJrFkqwfDQQGV6legflY4FpJMA0GCSqGSIb3DQEBBQUABIIBAHbp
# CllwBeEDUevOq06dmtlrPYKQpIsPfKAmSv4d9IgvBF1ljsi5c0Farr8J8QPbf+4U
# KdKCmwuXgm4EUBTL/bTsa2q/1QnDkzrkzf29GPgw8Cgis1k24yVYyd4L68cIWbBz
# mlIXbFXAb3+siO3+6/Wb3VVc8uz+KjeQ3dSf69+YVHyA4isdlU4XEIm4eb9dqKf6
# WceXj3ozv4j3kh6PzrjQ8wJqsRrURF2BSc3Yu0byF2qsvBL8HFNRxyJNbLHkvu4Y
# KpO+f4nylYYm80JaSByr/CYmfoaKrDGk1lxTLiugwC76nHSBHcAaqP9wUPnA4OXM
# NYe5jj5OEokZ4SVM2dQ=
